...
const META = {
	color: "#A090C0", // change per category: market=#8FAF7A, essay=#C47A5A, notes=#A090C0
	desc: "Marginalia and summaries from books worth lingering over.",
};
			...
			>
				...
				>
					<div style={{ marginBottom: "1rem" }}>
						<CategoryBadge category="notes" size="md" />
					</div>
					<h1
						style={{
