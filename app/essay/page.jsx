...
const META = {
	color: "#C47A5A", // change per category: market=#8FAF7A, essay=#C47A5A, notes=#A090C0
	desc: "Thinking about being a student, making choices, and being nineteen.",
};
			...
			>
				...
				>
					<div style={{ marginBottom: "1rem" }}>
						<CategoryBadge category="essay" size="md" />
					</div>
					<h1
						style={{
